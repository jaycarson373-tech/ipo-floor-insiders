...
export const pumpioPreviews: Array<{
  ...
  { id: 421, art: "dealmaker", name: "The Dealmaker", rarity: "STANDARD", level: 1, capsule: "Cracked ivory / green", face: "Star-eye gold-tooth grin", outfit: "Toxic-fur pinstripe", accessory: "Sealed contract cube", background: "Night auction", surface: "Fever-dream ink", status: "COLLECTION PREVIEW" },
  { id: 187, art: "oracle", name: "The Oracle", rarity: "STANDARD", level: 2, capsule: "Stormglass / cobalt", face: "Mismatched oracle eyes", outfit: "Shrine-school uniform", accessory: "All-seeing calculator", background: "Flooded data shrine", surface: "Fever-dream ink", status: "COLLECTION PREVIEW" },
  { id: 333, art: "red-line", name: "The Red Line", rarity: "RARE", level: 7, capsule: "Split ivory / signal red", face: "Three-eye panic", outfit: "Patched racing jacket", accessory: "Lobster hotline", background: "Volcanic trading cathedral", surface: "Fever-dream ink", status: "COLLECTION PREVIEW" },
