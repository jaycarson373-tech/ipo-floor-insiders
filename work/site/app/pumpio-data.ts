...
export const pumpioPreviews: Array<{
  ...
  { id: 421, art: "dealmaker", name: "The Dealmaker", rarity: "STANDARD", level: 1, capsule: "Ivory / green", face: "Confident sideways grin", outfit: "Oversized charcoal blazer", accessory: "Lapel adjustment", background: "Pale sage", surface: "Lo-fi hand ink", status: "COLLECTION PREVIEW" },
  { id: 187, art: "analyst", name: "The Analyst", rarity: "STANDARD", level: 2, capsule: "Ivory / blue", face: "Skeptical raised brow", outfit: "Navy sweater vest", accessory: "Chunky calculator", background: "Powder blue", surface: "Lo-fi hand ink", status: "COLLECTION PREVIEW" },
  { id: 333, art: "floor-trader", name: "The Floor Trader", rarity: "RARE", level: 7, capsule: "Ivory / red", face: "Mid-negotiation", outfit: "Dark pinstripe jacket", accessory: "Telephone receiver", background: "Muted coral", surface: "Lo-fi hand ink", status: "COLLECTION PREVIEW" },
