...
const artMap: Record<PumpioArtId, { alt: string; quadrant?: number; src: string }> = {
  dealmaker: { alt: "The Dealmaker, a lo-fi hand-inked green and ivory Pumpio adjusting a charcoal blazer lapel", src: "/pumpios/v6/dealmaker.webp" },
  analyst: { alt: "The Analyst, a lo-fi hand-inked blue and ivory Pumpio checking a chunky calculator", src: "/pumpios/v6/analyst.webp" },
  "floor-trader": { alt: "The Floor Trader, a lo-fi hand-inked red and ivory Pumpio negotiating on a telephone", src: "/pumpios/v6/floor-trader.webp" },
