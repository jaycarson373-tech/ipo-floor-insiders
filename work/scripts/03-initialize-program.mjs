...
console.log('IPO Floor launch configuration');
...
console.log('IPO lock vault:  ', ipoVault.toBase58());
...
if (!programAccount?.executable) throw new Error('Deploy the IPO Floor program before initialization.');
